"""CLI for entropy-guided text watermark injection."""
...
from src.content_watermark.codec import embed_payload
...
def main() -> None:
    ...
    print(json.dumps(embed_payload(payload).to_dict(), ensure_ascii=False, indent=2))
